#PBS -N SOR_FirstTouch_V1_Time_Alloc_Master_AllTests_Java
...
alg="SOR_FirstTouch_V1_alloc_e_master"
exe="$HOME/NUMA_Aware_Thesis/java_codes/jar/sor_FirstTouch_corrected_V1_alloc_e_master.jar"
################################################################
