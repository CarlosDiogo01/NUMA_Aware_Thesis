#PBS -N SOR_FirstTouch_V1_Time_MasterOnly_AllTests_Java
...
alg="SOR_FirstTouch_V1_master_only"
exe="$HOME/NUMA_Aware_Thesis/java_codes/jar/sor_FirstTouch_corrected_V1_master.jar"
################################################################
