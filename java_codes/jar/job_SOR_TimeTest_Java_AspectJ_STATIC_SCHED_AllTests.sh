#PBS -N SOR_NUMA_AllTests_Java_AspectJ_STATIC_SCHEDULE_NUMACTL_TimeTest
...
alg="SOR_AJ_STATIC_SCHED"

#Tests with SM_lib_barrier STATIC schedule
exe1="SOR_AJ__SM_lib_barrier__for_static.jar"
exe2="SOR_AJ__SM_used_defined_barrier__for_static.jar"
