#PBS -N VTune_SOR_SEQ_Improved_UseNUMA
...
VTune_output_dir="$HOME/NUMA_Aware_Thesis/java_codes/VTune_Tests/sor_SEQ_Improved_j8_UseNumaFlag_$node_info"
# Java Dir 
...
mv VTune_SOR_SEQ_Improved_UseNUMA* sor_SEQ_Improved_j8_UseNumaFlag_$node_info/
