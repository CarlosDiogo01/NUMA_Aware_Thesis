#PBS -N VTune_Result_SOR_SEQ_Improved
...
Vtune_output_dir="$HOME/NUMA_Aware_Thesis/java_codes/VTune_Tests/sor_SEQ_Improved_j8_$node_info"
# Java Dir 
...
# Collecting VTune Events for Size 5
