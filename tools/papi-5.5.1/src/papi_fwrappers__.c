...
void
 papif_assign_eventset_component__
# 185 "papi_fwrappers.c"
...
void
 ...
 papif_get_exe_info__
# 238 "papi_fwrappers.c"
 ( char *fullname, char *name, long long *text_start, long long *text_end, long long *data_start, long long *data_end, long long *bss_start, long long *bss_end, int *check, int fullname_len, int name_len )
...
# 303 "papi_fwrappers.c"
 papif_get_hardware_info__
# 291 "papi_fwrappers.c"
 ( int *ncpu, int *nnodes, int *totalcpus, int *vendor, char *vendor_str, int *model, char *model_str, float *revision, float *mhz, int vendor_len, int model_len )
...
void
 ...
 papif_get_event_info__
# 710 "papi_fwrappers.c"
 ( int *EventCode, char *symbol, char *long_descr, char *short_descr, int *count, char *event_note, int *flags, int *check, int symbol_len, int long_descr_len, int short_descr_len, int event_note_len )
