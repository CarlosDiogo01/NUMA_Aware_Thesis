...
{
      21,     0,    -1,    22,    -1,     6,    -1,     3,    -1,    18,
      15,     4,    16,    -1,     4,    -1,    22,     7,    22,    -1,
      22,     8,    22,    -1,    22,     9,    22,    -1,    22,    10,
      22,    -1,    22,    11,    22,    -1,    22,    12,    22,    -1,
      22,    13,    22,    -1,    22,    14,    22,    -1,    15,    22,
      16,    -1
};
...
{
  "$end", "error", "$undefined", "NUMBER", "COUNTER", "EXPOSANT",
  "BASE16", "ADD", "SUB", "MUL", "DIV", "OR", "AND", "SHR", "SHL",
  "B_LEFT", "B_RIGHT", "END", "DELTA", "POWER", "$accept", "Line",
  "Expression", 0
};
#endif
...
#line 63 "./calc.y"
    {
    (yyval.e) = build_node_counter((yyvsp[(1) - (1)].txt), 0);
}
    break;
...
#line 67 "./calc.y"
    {
    (yyval.e) = build_node_constant((yyvsp[(1) - (1)].txt));
}
    break;
...
#line 70 "./calc.y"
    {
    (yyval.e) = build_node_counter((yyvsp[(3) - (4)].txt), DELT);
}
    break;
...
#line 76 "./calc.y"
    {
    (yyval.e) = build_node_operation((yyvsp[(1) - (3)].e),(yyvsp[(3) - (3)].e), '+');
}
    break;
