#PBS -N SOR_JAVA_Improved_PERF_NUMA_DRAM_Counters
...
do
	...
	perf stat -e r5301d3 $t 

	echo "0x0c : PMU : [REMOTE_DRAM]"
	perf stat -e r530cd3 $t 

	echo "0x10 : PMU : [REMOTE_HITM]"
	perf stat -e r5310d3 $t 

	echo "0x20 : PMU : [REMOTE_FWD]"
	perf stat -e r5320d3 $t 
	...
	perf stat -e r5302d2 $t

	echo "0x04 : PMU : [XSNP_HITM]"
	perf stat -e r5304d2 $t

	echo "0x01 : PMU : [XSNP_MISS]"
	perf stat -e r5301d2 $t

	echo "0x08 : PMU : [XSNP_NONE]"
	perf stat -e r5308d2 $t
	...
	perf stat -e r5301b7,r400000 $t

	echo "0x7f800000 : PMU : [LLC_MISS_REMOTE_DRAM]"
	perf stat -e r5301b7,r7f800000 $t
	
	echo "0x800000000 : PMU : [SNP_FWD]"
	perf stat -e r5301b7,r800000000 $t

	echo "0x1000000000 : PMU : [HITM]"
	perf stat -e r5301b7,r1000000000 $t

	echo "0x2000000000 : PMU : [NON_DRAM]"
	perf stat -e r5301b7,r2000000000 $t

	# CACHE PREFETCH Counters
	echo "0x01 : PMU : [DMND_DATA_RD]"
	perf stat -e r5301b7,r1 $t 

	echo "0x02 : PMU : [DMND_RFO]"
	perf stat -e r5301b7,r2 $t

	echo "0x04 : PMU : [DMND_IFETCH]"
	perf stat -e r5301b7,r4 $t

	echo "0x10 : PMU : [PF_DATA_RD]"
	perf stat -e r5301b7,r10 $t

	echo "0x20 : PMU : [PF_RFO]"
	perf stat -e r5301b7,r20 $t

	echo "0x40 : PMU : [PF_IFETCH]"
	perf stat -e r5301b7,r40 $t

	echo "0x80 : PMU : [PF_LLC_DATA_RD]"
	perf stat -e r5301b7,r80 $t

	echo "0x100 : PMU : [PF_LLC_RFO]"
	perf stat -e r5301b7,r100 $t

	echo "0x200 : PMU : [PF_LLC_IFETCH]"
	perf stat -e r5301b7,r200 $t
	...
	# DRAM Memory Counters
	echo "0x400000 : PMU : [LLC_MISS_LOCAL]"
	perf stat -e r5301bb,r400000 $t

	echo "0x7f800000 : PMU : [LLC_MISS_REMOTE_DRAM]"
	perf stat -e r5301bb,r7f800000 $t

	echo "0x800000000 : PMU : [SNP_FWD]"
	perf stat -e r5301bb,r800000000 $t
	
	echo "0x1000000000 : PMU : [HITM]"
	perf stat -e r5301bb,r1000000000 $t
	
	echo "0x2000000000 : PMU : [NON_DRAM]"
	perf stat -e r5301bb,r2000000000 $t

	# CACHE PREFETCH Counters
	echo "0x01 : PMU : [DMND_DATA_RD]"
	perf stat -e r5301bb,r1	$t
	
	echo "0x02 : PMU : [DMND_RFO]"
	perf stat -e r5301bb,r2 $t
	
	echo "0x04 : PMU : [DMND_IFETCH]"
	perf stat -e r5301bb,r4 $t

	echo "0x10 : PMU : [PF_DATA_RD]"
	perf stat -e r5301bb,r10 $t

	echo "0x20 : PMU : [PF_RFO]"
	perf stat -e r5301bb,r20 $t

	echo "0x40 : PMU : [PF_IFETCH]"
	perf stat -e r5301bb,r40 $t

	echo "0x80 : PMU : [PF_LLC_DATA_RD]"
	perf stat -e r5301bb,r80 $t

	echo "0x100 : PMU : [PF_LLC_RFO]"
	perf stat -e r5301bb,r100 $t

	echo "0x200 : PMU : [PF_LLC_IFETCH]"
	perf stat -e r5301bb,r200 $t
done
