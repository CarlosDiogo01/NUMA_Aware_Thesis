#PBS -N SOR_First_Touched_v2_sem_pragmas_GOMP_CPU_Affinity_and_NUMACTL_C_TimeTest
...
alg="SOR_C_FirstTouch_v2_sem_pragmas"
exe="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_GCC_without_LoopFusion_v2_without_pragmas"
################################################################
