#PBS -N SOR_First_Touched_MultAllocSEQ_GOMP_CPU_Affinity_and_NUMACTL_C_TimeTest
...
alg="Sor_C_FT_GCC_MultAllocSEQ"
exe="$HOME/NUMA_Aware_Thesis/c_src/SOR_C_FirstTouch/Sor_sm_improvment_GCC/dist/Debug/OpenMPI-MacOSX/Sor_FT_MultAllocSEQ"
################################################################
