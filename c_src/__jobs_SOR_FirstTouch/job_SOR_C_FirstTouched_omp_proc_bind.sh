#PBS -N SOR_C_without_LoopFusion_v2_without_pragmas_procbind
...
alg="SOR_C_without_LoopFusion_v2_without_pragmas_procbind"
exe1="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_GCC_without_LoopFusion_v2_without_pragmas_procbind_master"
exe2="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_GCC_without_LoopFusion_v2_without_pragmas_procbind_spread"
exe3="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_GCC_without_LoopFusion_v2_without_pragmas_procbind_close"
################################################################
