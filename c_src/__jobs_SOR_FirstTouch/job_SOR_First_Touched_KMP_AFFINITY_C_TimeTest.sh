#PBS -N SOR_FirstTouched_KMP_AFFINITY_C_TimeTest
...
alg="SOR_C_FirstTouched_ICC_16_v2_sem_pragmas"
exe="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_ICC_without_LoopFusion_v2_without_pragmas"
################################################################
