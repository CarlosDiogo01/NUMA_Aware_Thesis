#PBS -N SOR_FirstTouched_MultAllocSEQ_KMP_AFFINITY_C_TimeTest
...
alg="Sor_C_FT_ICC16_MultAllocSEQ"
exe="$HOME/NUMA_Aware_Thesis/c_src/SOR_C_FirstTouch/Sor_sm_improvment_ICC/dist/Debug/OpenMPI-MacOSX/Sor_FT_ICC_MultAllocSEQ"
################################################################
