# Machine USED
node_info="KNL-002-1-Config-2_1"



############ Information about algorithm to run ################
alg="SOR_C_FirstTouch_ICC_KMP_AFFINITY"
exe="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_icc17_KNL_default_first_touched"
################################################################
