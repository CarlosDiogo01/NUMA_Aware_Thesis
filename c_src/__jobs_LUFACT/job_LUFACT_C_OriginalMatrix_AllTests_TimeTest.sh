#PBS -N LUFACT_C_OriginalMatrix_AllTests_TimeTest
...
alg="LUFACT_C_OriginalMatrix"
exe="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_matrix-original_gcc_530_default"
