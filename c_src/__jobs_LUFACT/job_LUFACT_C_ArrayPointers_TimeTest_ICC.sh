#PBS -N LUFACT_C_ArrayPointers_TimeTest_ICC
...
alg="LUFACT_C_Original_ArrayPointers_ICC"
exeICC="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_array_pointers_icc16"
exeICCprocbindmaster="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_array_pointers_icc_16_procbind_master"
exeICCprocbindspread="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_array_pointers_icc_16_procbind_spread"
exeICCprocbindclose="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_array_pointers_icc_16_procbind_close"
################################################################
