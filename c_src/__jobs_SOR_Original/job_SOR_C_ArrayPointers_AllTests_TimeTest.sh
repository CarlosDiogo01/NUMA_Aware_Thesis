#PBS -N SOR_C_ArrayPointers_AllTests_TimeTest
...
alg="SOR_C_Original_ArrayPointers"
exe="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_gcc530_original_array_pointers"
exeICC="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_icc16_original_array_pointers"
exeICCprocbindmaster="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_icc_16_array_pointers_procbind_master"
exeICCprocbindspread="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_icc_16_array_pointers_procbind_spread"
exeICCprocbindclose="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_icc_16_array_pointers_procbind_close"
################################################################
...
# Disable GOMP_CPU_AFFINITY to begin with KMP_AFFINITY tests
