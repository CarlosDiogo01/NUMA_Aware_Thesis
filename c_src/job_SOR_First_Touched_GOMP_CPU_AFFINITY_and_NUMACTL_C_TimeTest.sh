#PBS -N SOR_First_Touched_GOMP_CPU_Affinity_and_NUMACTL_C_TimeTest
...
alg="SOR_C_FirstTouch"
exe="$HOME/NUMA_Aware_Thesis/c_src/exes/sor_sm_improvment_GCC_530_first_touched"
################################################################
