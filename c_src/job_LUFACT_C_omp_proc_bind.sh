...
alg="LUFACT_C_proc_bind"
exe1="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_proc_bind_master"
exe2="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_proc_bind_spread"
exe3="$HOME/NUMA_Aware_Thesis/c_src/exes/lufact_sm_proc_bind_close"
################################################################
...
Project_Folder="$HOME/NUMA_Aware_Thesis/c_src/LUFACT_C/lufact_sm/${alg}_TimeTest_$node_info"
