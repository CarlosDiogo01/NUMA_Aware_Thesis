#PBS -N LUFACT_GOMP_CPU_AFFINITY_and_NUMACTL_C_TimeTest
...
alg="LUFACT_C"
exe="$HOME/NUMA_Aware_Thesis/c_src/LUFACT_C/lufact_sm/dist/Debug/OpenMPI-MacOSX/lufact_sm_gcc_default"
################################################################
