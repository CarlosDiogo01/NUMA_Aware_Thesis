 ...
 *
 * Demonstrate Intel(R) Cilk(TM) Plus mutexes.  This sample counts the total
 * number of times that the data is partitioned.
 */
...
// This implementation uses Intel(R) Cilk(TM) Plus and Intel(R) Threading Building
// Blocks mutexes.
...
int qmain(int n)
{
    ...
    std::cout << cilk_ticks_to_seconds(end_tick-start_tick) << " seconds" << std::endl;
    delete m;
